...
\draw [line width=1pt, color=red] (3,4)-- (1,2);
...
\draw [line width=2pt, color=blue, mydashed] (-0.3,0.8)--(6.3,0.8)--(6.3,4.2)--(-0.3,4.2)--(-0.3,0.8);
...
\draw[color=black] (3.3, 4.5) node {\Large $t=v$};
\draw[color=red] (1.1, 3.1) node {\Large $e^* = e$};
\draw[color=black] (0.5, 2.1) node {\Large $u$};
\draw[color=black] (5.5, 2.1) node {\Large $w$};
\end{scriptsize}
\end{tikzpicture}